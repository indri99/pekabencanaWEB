		...
		<div class="row pt-0 h-100 w-100">
			...
			<div class="col-6 d-flex align-items-center text-center">
				<div class="container">
					...
					<form class="form-login" role="form" action="loginKontributor.php" method="post">
						...
						<div class="mt-4">
							<button class="btn btn-lg btn-primary btn-block" type="submit" name="login_kontributor" style="background-color: #009624; border: #009624; color: black;">
								<b>LOGIN</b>
								<a href="#"></a>
							</button>
						</div>
