				...
				<div class="container">
					...
					<div class="row">
						<div class="col-6">
							...
							<form>
								<input class="MyButton" type="button" value="ADMINISTRATOR" onclick="window.location.href='loginAdministrator.php'" style="background-color: #eeeeee; border: #efefef; color: black;" />
							</form>
						</div>
						<div class="col-6">
							<img src="img/asKontributor.png" alt="kontributor" height="265" width="265" style="max-width:100%;height:auto;">
  							<form>
								<input class="MyButton" type="button" value="KONTRIBUTOR" onclick="window.location.href='loginKontributor.php'" style="background-color: #eeeeee; border: #efefef; color: black;" />
							</form>
						</div>
					</div>
				</div>
