                ...
                <li class="nav-item dropdown nav-user"><br>
                  <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="img/asAdministrator.png" alt="" class="user-avatar-md rounded-circle"></a>
                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                      ...
                      <a class="dropdown-item" hhref="index.php?logout='1'"><i class="fas fa-power-off mr-2"></i>     Logout</a>
                    </div>	
                </li>
              </ul>
            </div>
...
<div class="tabel">
  ...
  <table style="width:100%">
    ...
    <tr>
      <td><br>Hatta</td>
      <td><br>hattaz@gmail.com</td>
    </tr>
    <tr>
      <td><br>Dewi Rosmita</td>
      <td><br>rsmtdewi@gmail.com</td>
    </tr>
    <tr>
      <td><br>Fredi Irawan</td>
      <td><br>frediirawan@gmail.com</td>
    </tr>
    <tr>
      <td><br>Riskita Denada</td>
      <td><br>riskriskita@yahoo.com</td>
    </tr>
    <tr>
      <td><br>Adinda Ayu</td>
      <td><br>dindaayu99@icloud.com</td>
    </tr>
    <tr>
      <td><br>Emilia Rahayu</td>
      <td><br>emilrhy@yahoo.com</td>
    </tr>
  </table>      
</div>
<div class="container">
